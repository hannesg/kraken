...
build/kraken/the.o: src/kraken/the.cpp src/kraken/node.h src/kraken/attack.h src/kraken/the.h
	g++ -pthread -c --std=c++0x -Isrc -Itests src/kraken/the.cpp -o build/kraken/the.o
build/kraken/attack.o: src/kraken/attack.cpp src/kraken.h src/kraken/node.h src/kraken/link.h src/kraken/the.h src/kraken/attack.h
	g++ -pthread -c --std=c++0x -Isrc -Itests src/kraken/attack.cpp -o build/kraken/attack.o
...
./test_node_result: build/test_node_result.o build/kraken/node.o build/kraken/node/result.o build/kraken/node/terminal.o build/kraken/visitor.o build/kraken/base.o
	g++ -pthread --std=c++0x -Isrc -Itests build/test_node_result.o build/kraken/node.o build/kraken/node/result.o build/kraken/node/terminal.o build/kraken/visitor.o build/kraken/base.o  -o test_node_result
...
build/test_attack.o: tests/test_attack.cpp src/kraken.h
	g++ -pthread -c --std=c++0x -Isrc -Itests tests/test_attack.cpp -o build/test_attack.o
./test_attack: build/test_attack.o build/kraken.o build/kraken/the.o build/kraken/node.o build/kraken/attack.o build/kraken/visitor.o build/kraken/base.o build/kraken/node/result.o build/kraken/link.o
	g++ -pthread --std=c++0x -Isrc -Itests build/test_attack.o build/kraken.o build/kraken/the.o build/kraken/node.o build/kraken/attack.o build/kraken/visitor.o build/kraken/base.o build/kraken/node/result.o build/kraken/link.o  -o test_attack
...
./test_link: build/test_link.o build/kraken/link.o build/kraken/node/result.o build/kraken/node.o build/kraken/visitor.o build/kraken/base.o
	g++ -pthread --std=c++0x -Isrc -Itests build/test_link.o build/kraken/link.o build/kraken/node/result.o build/kraken/node.o build/kraken/visitor.o build/kraken/base.o  -o test_link
