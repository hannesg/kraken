...
build/kraken/node/result.o: src/kraken/node/result.cpp src/kraken/node.h src/kraken/string.h src/kraken/node/result.h
...
./test_node_pool: build/test_node_pool.o build/kraken/node.o build/kraken/node/map.o build/kraken/node/terminal.o build/kraken/node/result.o build/kraken/base.o build/kraken/visitor.o src/kraken/range_map.h src/kraken/range_set.h build/kraken/string.o
...
./test_attack: build/test_attack.o build/kraken.o build/kraken/the.o build/kraken/node.o build/kraken/attack.o build/kraken/visitor.o build/kraken/base.o build/kraken/node/result.o build/kraken/link.o build/kraken/string.o
	g++  -pthread -Wall -std=c++0x build/test_attack.o build/kraken.o build/kraken/the.o build/kraken/node.o build/kraken/attack.o build/kraken/visitor.o build/kraken/base.o build/kraken/node/result.o build/kraken/link.o build/kraken/string.o  -o test_attack
...
./test_link: build/test_link.o build/kraken/link.o build/kraken/node/result.o build/kraken/node.o build/kraken/string.o build/kraken/visitor.o build/kraken/base.o
	g++  -pthread -Wall -std=c++0x build/test_link.o build/kraken/link.o build/kraken/node/result.o build/kraken/node.o build/kraken/string.o build/kraken/visitor.o build/kraken/base.o  -o test_link
all: ./test_node_result ./test_node_pool ./test_range_map ./test_attack ./test_token ./test_link
clean: 
	rm -rf ./test_node_result ./test_node_pool ./test_range_map ./test_attack ./test_token ./test_link build/kraken.o build/kraken/link.o build/kraken/visitor.o build/kraken/the.o build/kraken/attack.o build/kraken/string.o build/kraken/node.o build/kraken/node/placeholder.o build/kraken/node/result.o build/kraken/node/fork.o build/kraken/node/terminal.o build/kraken/node/replacer.o build/kraken/node/map.o build/kraken/token.o build/kraken/base.o
