...
build/test_attack.o: tests/test_attack.cpp src/kraken.h src/kraken/string.h
	g++ -c  -pthread -Wall -std=c++0x -Isrc -Itests tests/test_attack.cpp -o build/test_attack.o
./test_attack: build/test_attack.o build/kraken.o build/kraken/string.o build/kraken/the.o build/kraken/base.o build/kraken/node.o build/kraken/attack.o build/kraken/visitor.o build/kraken/node/result.o build/kraken/link.o
	g++  -pthread -Wall -std=c++0x build/test_attack.o build/kraken.o build/kraken/string.o build/kraken/the.o build/kraken/base.o build/kraken/node.o build/kraken/attack.o build/kraken/visitor.o build/kraken/node/result.o build/kraken/link.o  -o test_attack
