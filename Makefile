...
build/kraken/node.o: src/kraken/node.cpp src/kraken/node.h src/kraken/visitor.h src/kraken/base.h src/kraken/decoder.h src/kraken/node/result.h
...
build/kraken/node/result.o: src/kraken/node/result.cpp src/kraken/decoder.h src/kraken/node.h src/kraken/node/result.h
...
build/mock_string.o: tests/mock_string.cpp tests/mock_string.h src/kraken/decoder.h
...
build/test_node_map.o: tests/test_node_map.cpp tests/mock_string.h src/kraken/node/map.h src/kraken/node/terminal.h
...
build/test_attack.o: tests/test_attack.cpp src/kraken/base.h tests/mock_string.h src/kraken/attack.h src/kraken/the.h src/kraken/node/map.h src/kraken/node/terminal.h
...
build/test_token.o: tests/test_token.cpp src/kraken/token.h src/kraken/node.h src/kraken/node/terminal.h
